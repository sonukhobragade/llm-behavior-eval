...
# Collecting the whole tree catches an import error in a module that no test
# happens to import. Unlike the step above, this must find tests: exit 5 here
# would mean the suite vanished.
step "Collection smoke"                     'pytest --collect-only -q'
